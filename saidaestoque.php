...
<a href="sistema.php">Página Principal</a> | <a href="estoque.php">Estoque Geral</a>		|	<a href="bares.php">Bares</a>	
	 ...
	 <div id="conteudo">
	  ...
	  <form id="adestoque" method="post" action="addestoque.php">
	   ...
	   <?php } ?>
	   <tr><td>Bar</td><td><select name="bar"><?php $query=mysql_query("SELECT * FROM bares");?>
	  <?php while($rows=mysql_fetch_assoc($query)){ ?>
	 <option  value="<?php echo $rows['idbar']; ?>"><?php echo $rows['nomebar']; ?></option>
	 <?php } ?>
	  </select>
	  </td>
	  </tr>
